    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                @endif
                    <form method="POST" action="{{ route('builders.update', $builder->id) }}" enctype="multipart/form-data" data-parsley-validate>
                    @method('PATCH')
                    @csrf
                        ...
                        <div class="row">
                            <div class="form-group col-sm-4">
                                ...
                                <input type="text" name="party_name" value="{{ $builder->party_name }}" id="party-name" maxlength="100" placeholder="Builder Name" class="form-control" required />
                            </div>
                            <div class="form-group col-sm-4"><label class=" col-form-label">Postal Address<span style="color:red;">*</span> </label>
                                <input type="text" name="postal_address" value="{{ $builder->postal_address }}" placeholder="Postal Address" maxlength="100" class="form-control" required /> 
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <input type="text" name="village" value="{{ $builder->village }}" id="village" maxlength="100" placeholder="Enter Village" class="form-control" required/>
                            </div>
                        </div>
                        <div class="row">   
                            <div class="form-group col-sm-4">
                                <label class=" col-form-label">Taluka<span style="color:red;">*</span></label>
                                <input type="text" name="taluka" value="{{ $builder->taluka }}" maxlength="100" placeholder="Enter Taluka" class="form-control" required/> 
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="col-form-label">District<span style="color:red;">*</span></label>
                                <input type="text" name="district" value="{{ $builder->district }}" id="district" maxlength="100" placeholder="Enter District" class="form-control" required />
                            </div>
                            <div class="form-group col-sm-4">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-4">
                                ...
                                <input type="text" name="pincode" value="{{ $builder->pincode }}" required id="pincode" maxlength="6" placeholder="Enter pincode" class="form-control" data-parsley-type="number" />
                            </div>
                            <div class="form-group col-sm-4">
                                <label class=" col-form-label">Name of Owner<span style="color:red;">*</span></label>
                                <input type="text" name="owner_name" value="{{ $builder->owner_name }}" maxlength="100" placeholder="Enter owner name" class="form-control" required /> 
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="col-form-label">Owner Landline Number</label>
                                <input type="text" name="owner_landline" value="{{ $builder->owner_landline }}" maxlength="20" id="owner_landline" placeholder="Enter landline number" class="form-control" />
                            </div>
                        </div>
                        <div class="row"> 
                            <div class="form-group col-sm-4">
                                <label class=" col-form-label">Owner Mobile Number <span style="color:red;">*</span></label>
                                <input type="text" name="owner_mobile" value="{{ $builder->owner_mobile }}" required data-parsley-type="number" maxlength="10" placeholder="Enter owner mobile" class="form-control"> 
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="col-form-label">Contact Person Landline Number</label>
                                <input type="text" name="contact_person_landline" value="{{ $builder->contact_person_landline }}" maxlength="20" id="contact_person_landline" placeholder="Contact Person landline number" class="form-control" />
                                <small style="color:green;">*For routine work</small>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class=" col-form-label">Contact Person Mobile Number </label>
                                <input type="text" name="contact_person_mobile" value="{{ $builder->contact_person_mobile }}" data-parsley-type="number" maxlength="10" placeholder="Enter Contact Person mobile" class="form-control"> 
                                <small style="color:green;">*For routine work</small>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-4">
                                ...
                                <div class="">
                                    <input type="text" maxlength="50" value="{{ $builder->total_consumption }}" class="form-control" name="total_consumption" />
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <div class="">
                                    <input type="text" maxlength="50" value="{{$builder->monthly_consumption}}" class="form-control" name="monthly_consumption" required />
                                </div>
                            </div>
                            <div class="form-group col-sm-4">
                                ...
                                <div class="i-checks">
                                    <input type="radio" value="dealer" name="order_procured" required {{($builder->order_procured == 'dealer') ? "checked" : ''}}> Dealer &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" value="tpca" name="order_procured" required {{($builder->order_procured == 'tpca') ? "checked" : ''}}> TPCA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" value="direct_party" name="order_procured" required {{($builder->order_procured == 'direct_party') ? "checked" : ''}}> Direct Party &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" value="other" name="order_procured" required {{($builder->order_procured == 'order_procured') ? "checked" : ''}}> Any Other 
                                </div>
                            </div>
                        </div>
                        ...
                        @foreach($site_destinations as $key=>$site_destination)
                            <?php
                                if($key == 0) $is_required = "required";
                            ?>
                        <div class="row dynamic-site">
                            <div class="form-group col-sm-2">
                                <label class="col-form-label">Destination</label>
                                <input type="text" class="form-control" value="{{$site_destination['destination']}}" name="site_destination[]" {{$is_required ?? ''}} />
                            </div>
                            <div class="form-group col-sm-2">
                                <label class="col-form-label">Taluka</label>
                                <input type="text" class="form-control" value="{{$site_destination['taluka'] ?? 'N/A'}}" name="site_taluka[]" required/>   
                            </div>
                            <div class="form-group col-sm-2">
                                <label class="col-form-label">District</label>
                                <input type="text" class="form-control" name="site_district[]" value="{{$site_destination['district'] ?? 'N/A'}}" required/>   
                            </div>
                            <div class="form-group col-sm-2">
                                <label class="col-form-label">Site Contact</label>
                                <input type="text" class="form-control" value="{{$site_destination['contact'] ?? ''}}" name="site_cntct[]" {{$is_required ?? ''}}/>
                            </div>
                            <div class="form-group col-sm-1">
                                <br><br>
                                @if($key == 0)
                                    <a href="javascript:void(0);" class="add_button" style="font-size: 22px; color: green;"><i class="fa fa-plus"></i></a>
                                @else 
                                    <a href="javascript:void(0);" class="remove_button" style="font-size: 22px; color: red;"><i class="fa fa-minus"></i></a>
                                @endif
                            </div>
                        </div>
                        @endforeach
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <input type="email" maxlength="50" value="{{ $builder->direct_customer_email }}" class="form-control" name="direct_customer_email" required />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" maxlength="60" value="{{ $builder->sales_rep_code }}" name="sales_rep_code" required class="form-control">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="form-control" maxlength="60" value="{{ $builder->credit_limit_period }}" name="credit_limit_period" />
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="form-control" value="{{ $builder->other_firm_details }}" maxlength="100" placeholder="Details here" id="other_firm_details" name=other_firm_details" {{($builder->is_dealing_other_firm == 0) ? "disabled": ''}} >
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-4">
                                ...
                                <input type="text" class="form-control" value="{{ $builder->branch_head }}" maxlength="50" name="branch_head" />
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="col-form-label">Party Code No</label>
                                <input type="text" class="form-control" value="{{ $builder->party_code }}"  maxlength="50" name="party_code" />
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="col-form-label">Factory Code No</label>
                                <input type="text" class="form-control" value="{{ $builder->factory_code }}" maxlength="50" name="factory_code" />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-4">
                                ...
                                <input type="text" class="form-control" value="{{ $builder->dist_code }}" maxlength="50" name="dist_code" />
                            </div>
                            <div class="form-group col-sm-4">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <input type="text" class="form-control" value="{{ $builder->frieght_code }}" maxlength="25" name="frieght_code"  />
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-sm-4">
                                <label class="col-form-label">A/C Ahemdabad</label>
                                <input type="text" class="form-control" value="{{ $builder->ac_ahmdbd }}" maxlength="25" name="ac_ahmdbd" />
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="col-form-label">GST No<span style="color:red;">*</span></label>
                                <input type="text" class="form-control" value="{{ $builder->gst_no }}" maxlength="25" name="gst_no" required>
                            </div>
                            <div class="form-group col-sm-4">
                                <label class="col-form-label">PAN Card No<span style="color:red;">*</span></label>
                                <input type="text" class="form-control" value="{{ $builder->pancard_no }}" maxlength="25" name="pan_no" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-sm-4">
                                ...
                                <select name="cement_brand" id="cement-brand" class="form-control cement-brand" required>
                                    ...
                                    <option {{($ckey == $builder->cement_brand) ? "selected" : ''}}  value="{{$ckey}}">{{$cvalue}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group col-sm-4">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <div class="pull-right">
                                    ...
                                    <a class="btn btn-info" href="{{ route('builder.review',$builder->id)}}"> Review </a>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var wrapper = $('.dynamic-site:last'); //Input field wrapper
        //var fieldHTML = '<div class="row dynamic-site"><div class="form-group col-sm-6"><label class="col-form-label">Destination</label><input type="text" class="form-control" name="site_destination[]" /></div><div class="form-group col-sm-3"><label class="col-form-label">Site Contact</label><input type="text" class="form-control" name="site_cntct[]"/></div><div class="form-group col-sm-2"><br><br><a href="javascript:void(0);" class="remove_button" style="font-size: 22px; color: red;"><i class="fa fa-minus"></i></div></div>';
