    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                @endif
                    <form method="POST" action="{{ route('update.profile') }}" data-parsley-validate>
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12">
                                ...
                                <input id="email" type="email" value="{{auth()->user()->email}}" class="form-control" name="email" readOnly />
                            </div>
                        </div>
